  ...
  return <div className="space-y-7">
    ...
    <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_320px]">
      ...
      <div className="space-y-5">
        <div className="saas-card p-5"><div className="flex items-center gap-2"><Sparkles size={15} className="text-violet"/><h2 className="h2">Quick actions</h2></div><div className="mt-4 space-y-2">
