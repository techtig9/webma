...
export function Hero() {
  ...
  return <section className="relative overflow-hidden">
    ...
    <div className="relative mx-auto grid max-w-7xl gap-14 px-5 pb-20 pt-20 lg:grid-cols-[.9fr_1.1fr] lg:items-center lg:px-8 lg:pb-28 lg:pt-28">
      <Reveal><div className="inline-flex items-center gap-2 rounded-full border border-signal/20 bg-signal/10 px-3 py-1.5 text-xs font-medium text-signal"><Sparkles size={12}/> AI website builder for everyone</div>
        <h1 className="mt-6 max-w-2xl font-display text-5xl font-bold leading-[.98] tracking-[-.04em] text-white md:text-7xl">Create a website <span className="text-signal">with AI.</span></h1>
